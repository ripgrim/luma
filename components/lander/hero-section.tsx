            ...
            <div className="mx-auto max-w-[1200px] md:px-8">
                <div className="max-w-2xl mx-auto sm:mx-0">
                    <div className="space-y-6 text-center sm:text-left">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-700 text-white leading-[1.3] sm:leading-[1.1] tracking-normal">The <span className="text-white/90 italic">only</span> trading platform you need</h1>
