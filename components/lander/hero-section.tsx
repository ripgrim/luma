...
const EmailInput = memo(({ value, onChange }: { value: string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) => (
    <Input
        type="email"
        placeholder="Enter your email"
        value={value}
        onChange={onChange}
        className="bg-white/10 border-white/20 focus:border-white/30 text-white placeholder-white/40"
    />
))
EmailInput.displayName = 'EmailInput'

const CodeInput = memo(({ value, onChange }: { value: string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) => (
    <Input
        type="text"
        ...
        onChange={onChange}
        maxLength={6}
        className="bg-white/10 border-white/20 focus:border-white/30 text-white placeholder-white/40 text-center"
    />
))
