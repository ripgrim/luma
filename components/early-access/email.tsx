...
export default function VerificationCodeEmail({ verificationCode }: VerificationCodeEmailProps) {
    return (
        <Html>
            <Head />
            <Body style={main}>
                ...
                <Container style={container}>
                    <Section style={coverSection}>
                        ...
                        <Section style={upperSection}>
                            ...
                            <Text style={mainText}>Thanks for signing up for my waitlist 😁</Text>
                        ...
                        <Section style={lowerSection}>
                            <Text style={cautionText}>
                                Luma will never email you and ask you to disclose or verify your
